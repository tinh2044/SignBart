...
| ASL-Citizen-200     | [ASL-Citizen-200.pth](https://drive.google.com/file/d/1ozoHRUQy-wPYkKPQWGzOsjYrTUj_q5ZC/view?usp=drive_link)| [ASL-Citizen-200.yaml](configs/ASL-Citizen-200.yaml) |
...
git clone https://github.com/<your_org>/SignBart.git
cd SignBart
...
- Convert any `.safetensors` in `pretrained_models/` to PyTorch format:
  ```bash
  python safetensors_2_pth.py
  ```
